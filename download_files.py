...
if __name__ == "__main__":
    ...
    parser.add_argument("--load_dataset", action="store_true", help="Download and unzip dataset")
    parser.add_argument("--load_checkpoint", action="store_true", help="Download and unzip checkpoint")
